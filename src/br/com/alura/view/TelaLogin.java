...
public class TelaLogin extends JFrame implements ActionListener, KeyListener {
	...
	//Componentes da tela
		JButton btnEntrar, btnRedefinirSenha;
	...
	private void init() {
		...
		//Instanciando e definindo valores e dimensões para os componentes
				...
				btnRedefinirSenha.setBounds( 20, 						// parâmetro: 'x' - define localizacao do botão  -->  
										225,						// parâmtro: 'y' - define localizacao do botão  ^
										(getWidth()/2) - 25, 		// parâmetro: "Widht" - define a largura do botão 
										35);						// parâmetro: "Height" - define a altura do botão
				//Botão Acessar
				btnEntrar = new JButton("Acessar");
				btnEntrar.setBounds( getWidth()/2,   				// parâmetro: 'x' - define localizacao do botão  -->  
									 btnRedefinirSenha.getY(),   		// parâmtro: 'y' - define localizacao do botão  ^
									 btnRedefinirSenha.getWidth(), 		// parâmetro: "Widht" - define a largura do botão 
									 btnRedefinirSenha.getHeight() );	// parâmetro: "Height" - define a altura do botão		
				//Lable Título
				...
				lblLogin.setFont(f);
				lblLogin.setBounds( btnRedefinirSenha.getX(),			//parâmetro: 'x' - define a localização do label  -->  
				...
				lblSenha.setFont(f);
				lblSenha.setBounds( btnRedefinirSenha.getX(),			//parâmetro: 'x' - define localizacao do label  -->  
				...
				btnRedefinirSenha.addActionListener(this);
				add(btnEntrar);
